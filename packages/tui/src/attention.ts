...
} from "@grexcode-ai/plugin/tui"
import { AttentionSoundName, type TuiConfig } from "./config"
import { Schema } from "effect"
import stripAnsi from "strip-ansi"
import * as TuiAudio from "./audio"
import defaultSoundPath from "@grexcode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@grexcode-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@grexcode-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@grexcode-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@grexcode-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@grexcode-ai/ui/audio/yup-01.mp3" with { type: "file" }
